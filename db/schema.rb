...
ActiveRecord::Schema[7.0].define(version: 2022_02_14_201719) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "group_spendings", force: :cascade do |t|
    t.bigint "group_id", null: false
    t.bigint "spending_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_group_spendings_on_group_id"
    t.index ["spending_id"], name: "index_group_spendings_on_spending_id"
  end
