...
group1 = Group.create!(name:'Group 1', icon: 'https://www.shareicon.net/data/128x128/2017/07/13/888371_aim_512x512.png', author_id: user1.id);
group2 = Group.create!(name:'Group 2', icon: 'https://www.shareicon.net/data/128x128/2017/07/13/888372_man_512x512.png', author_id: user1.id);
...
group5 = Group.create!(name:'Group 5', icon: 'https://www.shareicon.net/data/128x128/2017/07/13/888372_man_512x512.png', author_id: user2.id);
